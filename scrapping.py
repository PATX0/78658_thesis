...
kucoindf2.to_csv('kucoin_reviews_1000_gb.csv', index=False)
...
# revolut = AppStore(country='gb', app_name='revolut', app_id = '886427730')
...
# revolutdf2.to_csv('revolut_reviews_1000.csv', index=False)